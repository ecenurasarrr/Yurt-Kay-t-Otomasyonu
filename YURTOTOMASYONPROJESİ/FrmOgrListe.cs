...
namespace YURTOTOMASYONPROJESİ
{
    public partial class FrmOgrListe : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtotomasyonuDataSet9.Ogrenci1' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.ogrenci1TableAdapter.Fill(this.yurtotomasyonuDataSet9.Ogrenci1);
